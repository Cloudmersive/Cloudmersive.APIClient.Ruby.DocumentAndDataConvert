...
module CloudmersiveConvertApiClient
  ...
  class RenameXlsxWorksheetRequest
    ...
    attr_accessor :worksheet_to_rename

    # Required; The new name to be used for the worksheet
    attr_accessor :new_worksheet_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WorksheetToRename')
        self.worksheet_to_rename = attributes[:'WorksheetToRename']
      end

      if attributes.has_key?(:'NewWorksheetName')
        self.new_worksheet_name = attributes[:'NewWorksheetName']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          worksheet_to_rename == o.worksheet_to_rename &&
          new_worksheet_name == o.new_worksheet_name
    end
    ...
    def hash
      [input_file_bytes, input_file_url, worksheet_to_rename, new_worksheet_name].hash
    end
