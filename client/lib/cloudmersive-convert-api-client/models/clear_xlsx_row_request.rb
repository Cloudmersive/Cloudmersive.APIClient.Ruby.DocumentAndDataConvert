...
module CloudmersiveConvertApiClient
  ...
  class ClearXlsxRowRequest
    ...
    attr_accessor :worksheet_to_edit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WorksheetToEdit')
        self.worksheet_to_edit = attributes[:'WorksheetToEdit']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          worksheet_to_edit == o.worksheet_to_edit &&
    ...
    def hash
      [input_file_bytes, input_file_url, worksheet_to_edit, row_index].hash
    end
