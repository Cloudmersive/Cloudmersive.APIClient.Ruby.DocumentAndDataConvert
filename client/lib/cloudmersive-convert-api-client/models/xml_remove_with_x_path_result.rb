...
module CloudmersiveConvertApiClient
  ...
  class XmlRemoveWithXPathResult
    ...
    attr_accessor :xml_nodes_removed

    # Count of the matching results
    attr_accessor :nodes_removed_count
    ...
    def self.swagger_types
      {
        ...
        :'xml_nodes_removed' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'XmlNodesRemoved')
        if (value = attributes[:'XmlNodesRemoved']).is_a?(Array)
          self.xml_nodes_removed = value
        end
      end

      if attributes.has_key?(:'NodesRemovedCount')
        self.nodes_removed_count = attributes[:'NodesRemovedCount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          xml_nodes_removed == o.xml_nodes_removed &&
          nodes_removed_count == o.nodes_removed_count
    end
    ...
    def hash
      [successful, resulting_xml_document, xml_nodes_removed, nodes_removed_count].hash
    end
