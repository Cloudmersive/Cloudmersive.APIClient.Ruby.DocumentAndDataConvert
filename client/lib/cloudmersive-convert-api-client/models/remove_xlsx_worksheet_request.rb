...
module CloudmersiveConvertApiClient
  ...
  class RemoveXlsxWorksheetRequest
    ...
    attr_accessor :worksheet_to_remove
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'WorksheetToRemove')
        self.worksheet_to_remove = attributes[:'WorksheetToRemove']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          worksheet_to_remove == o.worksheet_to_remove
    end
    ...
    def hash
      [input_file_bytes, input_file_url, worksheet_to_remove].hash
    end
