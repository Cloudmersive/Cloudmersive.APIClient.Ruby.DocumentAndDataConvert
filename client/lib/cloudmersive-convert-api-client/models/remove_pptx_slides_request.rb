...
module CloudmersiveConvertApiClient
  ...
  class RemovePptxSlidesRequest
    ...
    attr_accessor :start_delete_slide_number

    # Slide number (1-based) to stop deleting slides; inclusive
    attr_accessor :end_delete_slide_number
    ...
    def self.swagger_types
      {
        ...
        :'start_delete_slide_number' => :'Integer',
        :'end_delete_slide_number' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StartDeleteSlideNumber')
        self.start_delete_slide_number = attributes[:'StartDeleteSlideNumber']
      end

      if attributes.has_key?(:'EndDeleteSlideNumber')
        self.end_delete_slide_number = attributes[:'EndDeleteSlideNumber']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          start_delete_slide_number == o.start_delete_slide_number &&
          end_delete_slide_number == o.end_delete_slide_number
    end
    ...
    def hash
      [input_file_bytes, input_file_url, start_delete_slide_number, end_delete_slide_number].hash
    end
