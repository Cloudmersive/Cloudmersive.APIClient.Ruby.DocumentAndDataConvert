...
module CloudmersiveConvertApiClient
  ...
  class SetPdfMetadataRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MetadataToSet')
        self.metadata_to_set = attributes[:'MetadataToSet']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metadata_to_set == o.metadata_to_set
    end
    ...
    def hash
      [input_file_bytes, metadata_to_set].hash
    end
