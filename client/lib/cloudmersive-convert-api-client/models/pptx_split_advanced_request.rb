...
module CloudmersiveConvertApiClient
  ...
  class PptxSplitAdvancedRequest
    # Input file
    attr_accessor :input_file

    # Slides per presentation for result
    attr_accessor :slides_per_presentation
    ...
    def self.swagger_types
      {
        :'input_file' => :'String',
        :'slides_per_presentation' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'SlidesPerPresentation')
        self.slides_per_presentation = attributes[:'SlidesPerPresentation']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          slides_per_presentation == o.slides_per_presentation
    end
    ...
    def hash
      [input_file, slides_per_presentation].hash
    end
