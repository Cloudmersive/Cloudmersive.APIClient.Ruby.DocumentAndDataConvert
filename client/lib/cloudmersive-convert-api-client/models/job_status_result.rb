...
module CloudmersiveConvertApiClient
  ...
  class JobStatusResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PptxResult')
        self.pptx_result = attributes[:'PptxResult']
      end
    ...
    def hash
      [successful, async_job_status, async_job_id, pptx_result, error_message].hash
    end
