...
module CloudmersiveConvertApiClient
  ...
  class DocxRemoveObjectRequest
    ...
    attr_accessor :path_to_object_to_remove
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PathToObjectToRemove')
        self.path_to_object_to_remove = attributes[:'PathToObjectToRemove']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          path_to_object_to_remove == o.path_to_object_to_remove
    end
    ...
    def hash
      [input_file_bytes, input_file_url, path_to_object_to_remove].hash
    end
