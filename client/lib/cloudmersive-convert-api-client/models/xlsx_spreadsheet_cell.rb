...
module CloudmersiveConvertApiClient
  ...
  class XlsxSpreadsheetCell
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StyleIndex')
        self.style_index = attributes[:'StyleIndex']
      end
    ...
    def hash
      [path, text_value, cell_identifier, style_index, formula].hash
    end
