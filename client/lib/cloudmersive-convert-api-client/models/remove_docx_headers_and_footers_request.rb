...
module CloudmersiveConvertApiClient
  ...
  class RemoveDocxHeadersAndFootersRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RemoveHeaders')
        self.remove_headers = attributes[:'RemoveHeaders']
      end

      if attributes.has_key?(:'RemoveFooters')
        self.remove_footers = attributes[:'RemoveFooters']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          remove_headers == o.remove_headers &&
          remove_footers == o.remove_footers
    end
    ...
    def hash
      [input_file_bytes, input_file_url, remove_headers, remove_footers].hash
    end
