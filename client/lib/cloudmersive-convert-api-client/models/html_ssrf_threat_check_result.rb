...
module CloudmersiveConvertApiClient
  ...
  class HtmlSsrfThreatCheckResult
    ...
    def self.swagger_types
      {
        :'is_valid' => :'BOOLEAN',
        :'is_threat' => :'BOOLEAN',
        :'threat_links' => :'Array<HtmlThreatLink>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ThreatLinks')
        if (value = attributes[:'ThreatLinks']).is_a?(Array)
          self.threat_links = value
        end
      end
    end
    ...
    def hash
      [is_valid, is_threat, threat_links].hash
    end
