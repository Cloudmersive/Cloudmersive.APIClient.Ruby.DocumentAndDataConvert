...
module CloudmersiveConvertApiClient
  ...
  class InsertDocxInsertParagraphRequest
    ...
    attr_accessor :paragraph_to_insert
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ParagraphToInsert')
        self.paragraph_to_insert = attributes[:'ParagraphToInsert']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paragraph_to_insert == o.paragraph_to_insert &&
    ...
    def hash
      [input_file_bytes, input_file_url, paragraph_to_insert, insert_placement, insert_path].hash
    end
