...
module CloudmersiveConvertApiClient
  ...
  class FindStringRegexRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TargetRegex')
        self.target_regex = attributes[:'TargetRegex']
      end
    ...
    def hash
      [text_content, target_regex, match_case].hash
    end
