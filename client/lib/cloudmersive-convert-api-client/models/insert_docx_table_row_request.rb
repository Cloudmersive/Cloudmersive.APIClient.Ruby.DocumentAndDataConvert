...
module CloudmersiveConvertApiClient
  ...
  class InsertDocxTableRowRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RowToInsert')
        self.row_to_insert = attributes[:'RowToInsert']
      end
    ...
    def hash
      [input_file_bytes, input_file_url, row_to_insert, insert_placement, existing_table_path].hash
    end
