...
module CloudmersiveConvertApiClient
  ...
  class DocxSetFooterRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FooterToApply')
        self.footer_to_apply = attributes[:'FooterToApply']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          footer_to_apply == o.footer_to_apply
    end
    ...
    def hash
      [input_file_bytes, input_file_url, footer_to_apply].hash
    end
